...
export default function IndustrySkillDescriptionCard({
  title,
  description,
  path,
}) {
  return (
    <div className="flex flex-col md:w-[20rem] justify-center  rounded-sm  transform duration-300 ">
      ...
      <Link
        to={path}
        className="text-center shadow-xl bg-blue-500 text-white py-3 px-10 rounded-sm mt-3 hover:bg-blue-400 transform duration-300 text-lg"
      >
        Learn More
      </Link>
    </div>
